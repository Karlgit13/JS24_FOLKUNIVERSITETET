...
var API_URL = "https://my-json-server.typicode.com/zocom-christoffer-wallenberg/books-api/books";
function fetchBooks() {
...
function displayBookList(books) {
    ...
    books.forEach(function (book) {
        ...
        bookDiv.innerHTML = "\n      <h3>".concat(book.title, "</h3>\n      <p>By: ").concat(book.author, "</p>\n      <button data-id=\"").concat(book.id, "\">More Info</button>\n    ");
        var button = bookDiv.querySelector("button");
...
function displayBookDetails(book) {
    ...
    detailsDiv.innerHTML = "\n    <h2>".concat(book.title, "</h2>\n    <p><strong>Author:</strong> ").concat(book.author, "</p>\n    <p>").concat(book.description, "</p>\n    <p><strong>Rating:</strong> ").concat(book.rating, "/5</p>\n    <button id=\"back-btn\">Back</button>\n  ");
    var backButton = detailsDiv.querySelector("#back-btn");
